...
@Component({
  ...
  templateUrl: './sales-order-overview.page.html',
  styleUrls: ['./sales-order-overview.page.scss'],
})
export class SalesOrderOverviewPage extends PageBase {
  ...
  ionViewDidEnter() {
    this.buildReturnReasonsChart();
    this.buildPerfectOrderRateChart();
    this.buildPerfectOrderRateGaugeChart();
    this.buildTotalOrdersChart();
  }

  async buildReturnReasonsChart() {
    //-----------Pie-Chart

    console.log('buildReturnReasonsChart');
    // await this.charts.ReturnReasonsChart.Chart?.dispose();

    // Create root element
    let amPieRoot = this.rpt.newPieRoot("ReturnReasonsChart");
    // this.charts.ReturnReasonsChart.Chart = amPieRoot;
  ...
  async buildPerfectOrderRateGaugeChart() {
    //-----------Gauge-Chart
    console.log('buildPerfectOrderRateGaugeChart');
    // await amGaugeRoot?.dispose();

    var amGaugeRoot = this.rpt.newGaugeRoot("PerfectOrderRateGaugeChart");
    // this.charts.PerfectOrderRateGaugeChart.Chart = amGaugeRoot;
  ...
  async buildTotalOrdersChart() {
    //-----------Column-Chart

    console.log('buildTotalOrdersChart');
    // await this.charts.TotalOrdersChart.Chart?.dispose();

    // Create root element
    let amColumnRoot = this.rpt.newColumnRoot("TotalOrdersChart");
