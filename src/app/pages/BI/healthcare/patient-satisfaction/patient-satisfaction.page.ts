...
@Component({
  ...
  templateUrl: './patient-satisfaction.page.html',
  styleUrls: ['./patient-satisfaction.page.scss'],
})
export class PatientSatisfactionPage extends PageBase {
  ...
  ionViewDidEnter() {
    this.buildPatientSatisfactionChart();
    this.buildPatientFailsChart();
    this.buildWaitingTimeChart();
  }

  async buildPatientSatisfactionChart() {
    //-----------Sorted-Bar-Chart

    console.log('buildPatientSatisfactionChart');
    // await this.charts.PatientSatisfactionChart.Chart?.dispose();

    // Create root element
    let amSortedBarRoot = this.rpt.newSortedBarRoot("PatientSatisfactionChart");
  ...
  async buildPatientFailsChart() {
    //-----------Trend-Lines-Chart

    console.log('buildPatientFailsChart');
    // await this.charts.PatientFailsChart.Chart?.dispose();

    // Create root element
    let amTrendLinesRoot = this.rpt.newTrendLinesRoot("PatientFailsChart");
  ...
  async buildWaitingTimeChart() {
    //-----------Gauge-Chart
    console.log('buildWaitingTimeChart');
    // await amGaugeRoot?.dispose();

    var amGaugeRoot = this.rpt.newGaugeRoot("WaitingTimeChart");
    // this.charts.WaitingTimeChart.Chart = amGaugeRoot;
