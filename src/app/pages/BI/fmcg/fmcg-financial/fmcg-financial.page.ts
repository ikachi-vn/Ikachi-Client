...
@Component({
  selector: 'app-fmcg-financial',
  templateUrl: './fmcg-financial.page.html',
  styleUrls: ['./fmcg-financial.page.scss'],
})
export class FmcgFinancialPage extends PageBase {
  ...
  ionViewDidEnter() {
    this.buildSupplyChainCostsChart();
    this.buildCashToCashCycleChart();
    this.buildCarryingCostsOfInventoryChart();
  }

  async buildSupplyChainCostsChart() {
    //-----------Gauge-Chart
    console.log('buildSupplyChainCostsChart');
    // await amGaugeRoot?.dispose();

    var amGaugeRoot = this.rpt.newGaugeRoot("SupplyChainCostsChart");
    // this.charts.SupplyChainCostsChart.Chart = amGaugeRoot;
  ...
  async buildCashToCashCycleChart() {
    //-----------Trend-Lines-Chart

    console.log('buildCashToCashCycleChart');
    // await this.charts.CashToCashCycleChart.Chart?.dispose();

    // Create root element
    let amTrendLinesRoot = this.rpt.newTrendLinesRoot("CashToCashCycleChart");
  ...
  async buildCarryingCostsOfInventoryChart() {
    //-----------Pie-Chart

    console.log('buildCarryingCostsOfInventoryChart');
    // await this.charts.CarryingCostsOfInventoryChart.Chart?.dispose();

    // Create root element
    let amPieRoot = this.rpt.newPieRoot("CarryingCostsOfInventoryChart");
    // this.charts.CarryingCostsOfInventoryChart.Chart = amPieRoot;
