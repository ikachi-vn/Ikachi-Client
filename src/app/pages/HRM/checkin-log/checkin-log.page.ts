...
export class CheckinLogPage extends PageBase {
    ...
    async massShiftAssignment(cData) {
        ...
        let it:any = {
            IDStaff: cData.SelectedStaff[0],
            Id: cData.Id || 0,
            // Remark
            LogTime: cData.FromDate,
            IDOffice:cData.Id || '',
            IDGate:cData.Id || '',
            // Image
            // IPAddress
        ...
        it.staffList = this.calendarOptions.resources;
        it.officeList = this.officeList;
        it.gateList = this.gateList;
        ...
        if (data) {
            ...
            data.DeliveryDatePart = lib.dateFormat(data.LogTime, 'yyyy-mm-dd');
            data.DeliveryTimePart = lib.dateFormat(data.LogTime, 'hh:MM');
            data.LogTime = data.DeliveryDatePart+' '+data.DeliveryTimePart+ ':00.0000000';
